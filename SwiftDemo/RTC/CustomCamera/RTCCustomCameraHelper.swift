...
/*
 ...
 2. Add audio and video I / O devices to the session: captureSession.addInput(audioDeviceInput)
                                                      captureSession.addOutput(videoOutput)
...
class  RTCCustomCameraHelper: NSObject {
...
extension RTCCustomCameraHelper : AVCaptureVideoDataOutputSampleBufferDelegate {
