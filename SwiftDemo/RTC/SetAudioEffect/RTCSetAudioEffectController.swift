//
//  RTCSetAudioEffectController.swift
//  TRTCSimpleDemo
//
...
class RTCSetAudioEffectController: NSViewController {
    ...
    override func prepare(for segue: NSStoryboardSegue, sender: Any?) {
        ...
        if "enterRTCSetAudioRoom" == segueId {
            ...
            guard let nextWindowExistsController = segue.destinationController as? NSWindowController,
                  let rtcNextViewController = nextWindowExistsController.contentViewController as? RTCSetAudioEffectViewController
            else {
                return
            }
